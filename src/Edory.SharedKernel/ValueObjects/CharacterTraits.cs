...
{
    public int Courage { get; } // Mut
    public int Creativity { get; } // Kreativität
    public int Helpfulness { get; } // Hilfsbereitschaft
    public int Humor { get; } // Humor
    public int Wisdom { get; } // Weisheit
    public int Curiosity { get; } // Neugier
    public int Empathy { get; } // Empathie
    public int Persistence { get; } // Ausdauer
