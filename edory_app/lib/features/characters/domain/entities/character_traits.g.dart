...
part of 'character_traits.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CharacterTraits _$CharacterTraitsFromJson(Map<String, dynamic> json) =>
    CharacterTraits(
...
Map<String, dynamic> _$CharacterTraitsToJson(CharacterTraits instance) =>
    <String, dynamic>{
